    ...
    public boolean createTable() {
        ...
        if (conn != null) {
            ...
            try {
                ...
                System.out.println("Creating sample_table");
                success = true;
            } catch (SQLException e) {
                System.out.println("Unable to create the database table");
                e.printStackTrace();
            } finally {
                if (stmt != null) {
                    try {
    ...
    public boolean dropTable() {
        ...
        if (conn != null) {
            ...
            try {
                ...
                System.out.println("Deleting sample_table");
                success = true;
            } catch (SQLException e) {
                System.out.println("Unable to create the database table");
                e.printStackTrace();
        ...
        if (person != null) {
            if (conn != null) {
                ...
                try {
                    ...
                    System.out.println("Unable to insert" + person.getFirstName() + " " + person.getLastName() + "into the table");
                    e.printStackTrace();
                } finally {
                    if (pstmt != null) {
                        try {
    ...
    public SamplePerson getPersonById(int id) {
        ...
        if (conn != null) {
            ...
            try {
                ...
                System.out.println("Unable query person by ID(" + id + ")");
                e.printStackTrace();
            } finally {
                if (pstmt != null) {
                    try {
